...
/* Lazy Load 1.9.3 - MIT license - Copyright 2010-2013 Mika Tuupola */! function(g, f, j, i) {
    var h = g(f);
...
/* Lazy Load 1.9.3 - MIT license - Copyright 2010-2013 Mika Tuupola */! function() {
    ...
    a.inputFocusBlur = function(b) {
        ...
        c.each(function(e, g) {
            ...
            d.focus(function() {
                var h = a(this).val();
                if (h == f) {
                    a(this).val("").addClass("focus");
                }
            }).blur(function() {
                var h = a(this).val();
                if (h == "") {
                    a(this).val(f).removeClass("focus");
                }
            });
        });
    };
...
(function(a) {
    a.qfangDialog = {
        initMask: function(e) {
            var d, c;
            d = a.qfangDialog.setHeight();
            c = a.qfangDialog.setWidth();
            var b = a("<div id='" + e + "' class='mask-overlay'></div>").appendTo("body").css({
                width: c,
                height: d,
                zIndex: 888888
            });
            a(window).bind("resize", {
                id: e.substring(0, e.length - 5)
            }, function(f) {
                a.qfangDialog.resize(f.data.id);
            });
        },
        MaskShow: function(b) {
            a("#" + b).show();
        ...
        setHeight: function() {
            if (a.browser.msie) {
                ...
                if (a.browser.version == 8) {
                    return (document.body.scrollHeight > a(window).height() ? document.body.scrollHeight : a(window).height());
                }
                if (c < b) {
        ...
        DialogShow: function(d, b) {
            ...
            if (b.modal) {
                var c = d + "_mask";
                if (a("#" + c).length == 0) {
                    a.qfangDialog.initMask(c);
                }
                a.qfangDialog.MaskShow(c);
            }
            a("#" + d).css({
                position: (a.browser.msie && a.browser.version == 6) ? "absolute" : "fixed",
                zIndex: 999999
            });
            if (a.browser.msie && a.browser.version <= 6) {} else {
                a.qfangDialog.DialogDrag(d);
            }
            a.qfangDialog.setCenterPosition(d);
            a("#" + d).show();
            if (b.callback && a.isFunction(b.callback)) {
                b.callback();
            }
            a(window).unbind("resize." + d);
            a(window).bind("resize." + d, {
                id: d
            }, function(f) {
                if (a("#" + d + ":visible").length > 0) {
                    a.qfangDialog.setCenterPosition(f.data.id);
                }
            });
        },
        DialogClose: function(c, b) {
            var b = a.extend({
                modal: true
            }, b);
            if (b.modal) {
                a.qfangDialog.MaskHide(c + "_mask");
            }
            a("#" + c).hide();
        },
        DialogDrag: function(b) {
            var e = a("#" + b),
                g = e[0],
                f = e.find("div.dialog-show-title"),
                j = f[0],
                d = e.find("p.btn-dialogclose"),
                h = d[0],
                c = false,
                i = disY = 0;
            if (d.length) {
                h.onmousedown = function(k) {
                    (k || window.event).cancelBubble = true;
                };
                j.onmousedown = function(k) {
                    var k = k || window.event;
                    c = true;
                    i = k.clientX - g.offsetLeft;
                    disY = k.clientY - g.offsetTop;
                ...
                document.onmousemove = function(n) {
                    ...
                    var l = n.clientX - i;
                    var m = n.clientY - disY;
                    var o = document.documentElement.clientWidth - g.offsetWidth;
                    var k = document.documentElement.clientHeight - g.offsetHeight;
                    l = l < 0 ? 0 : l;
                    l = l > o ? o : l;
                    m = m < 0 ? 0 : m;
                    m = m > k ? k : m;
                    g.style.marginTop = g.style.marginLeft = 0;
                    g.style.left = l + "px";
                    g.style.top = m + "px";
                    return false;
                };
                document.onmouseup = window.onblur = j.onlosecapture = function() {
                    c = false;
                    j.releaseCapture && j.releaseCapture();
                };
            }
        },
        setCenterPosition: function(g) {
            var d = a("#" + g);
            var c = a(window),
                e = a(document),
                f = e.scrollTop(),
        ...
        resize: function(b) {
            a("#" + b + "_mask").css({
                ...
                width: a.qfangDialog.setWidth(),
                height: a.qfangDialog.setHeight()
            });
        }
    };
})(jQuery);
(function(b) {
    ...
    b.path.bezier = function(h, e) {
        ...
        this.css = function(l) {
            ...
            j.x = this.x = (this.p1[0] * i + this.p2[0] * n + this.p3[0] * m + this.p4[0] * k + 0.5) | 0;
            j.y = this.y = (this.p1[1] * i + this.p2[1] * n + this.p3[1] * m + this.p4[1] * k + 0.5) | 0;
            j.left = j.x + "px";
            j.top = j.y + "px";
            return j;
        };
    };
    b.path.arc = function(e, c) {
        for (var d in e) {
            this[d] = e[d];
        }
        this.dir = this.dir || 1;
        ...
        this.css = function(h) {
            var f = (this.start * (h) + this.end * (1 - (h))) * Math.PI / 180,
                g = {};
            if (c) {
                g.prevX = this.x;
                g.prevY = this.y;
            }
            g.x = this.x = (Math.sin(f) * this.radius + this.center[0] + 0.5) | 0;
            g.y = this.y = (Math.cos(f) * this.radius + this.center[1] + 0.5) | 0;
            g.left = g.x + "px";
            g.top = g.y + "px";
            return g;
        };
    };
    b.fx.step.path = function(d) {
        var c = d.end.css(1 - d.pos);
        if (c.prevX != null) {
            b.cssHooks.transform.set(d.elem, "rotate(" + Math.atan2(c.prevY - c.y, c.prevX - c.x) + ")");
        }
        d.elem.style.top = c.top;
        d.elem.style.left = c.left;
    };
})(jQuery);
(function(a) {
    a.qfangDragDiv = function(b) {
        var c = a(b);
        c.each(function(h, d) {
            var i = c[0],
                g = c.find(".js-dragbar"),
                l = g[0],
                f = c.find(".js-closebtn"),
                j = f[0],
                e = false,
                k = disY = 0;
            if (f.length) {
                ...
                l.onmousedown = function(m) {
                    ...
                    e = true;
                    k = m.clientX - i.offsetLeft;
                    disY = m.clientY - i.offsetTop;
                    this.setCapture && this.setCapture();
                    return false;
                };
                document.onmousemove = function(p) {
                    ...
                    var n = p.clientX - k;
                    var o = p.clientY - disY;
                    var q = document.documentElement.clientWidth - i.offsetWidth;
                    var m = document.documentElement.clientHeight - i.offsetHeight;
                    n = n < 0 ? 0 : n;
                    n = n > q ? q : n;
                    o = o < 0 ? 0 : o;
                    o = o > m ? m : o;
                    i.style.marginTop = i.style.marginLeft = 0;
                    i.style.left = n + "px";
                    i.style.top = o + "px";
                    return false;
                };
                document.onmouseup = window.onblur = l.onlosecapture = function() {
                    e = false;
    ...
    a.fn.qfangSetTab = function(b) {
        ...
        return this.each(function() {
            var g = b,
                ...
                e = a("." + g.tabFrame),
                d;
            f.on(g.triggerEvent, function() {
                d = a(this);
                e.hide().addClass("dn").eq(f.index(d)).show().removeClass("dn");
                f.removeClass(g.tabLinkSelected);
                d.addClass(g.tabLinkSelected);
            });
        });
    };
})(jQuery);
(function(e) {
    ...
    function d(k, l) {
        ...
        var m = "";
        if (!c) {
            j = '<div class="alert-tips-wrap"><div class="alert-tips-inner">';
            m = "</div></div>";
        }
        var h = "";
        h += j + '<i class="icons-alert-tips ' + i + '"></i>' + '<div class="alert-tips-content">' + l + "</div>" + m;
        if (c) {
            if (e(".alert-tips-wrap").is(":hidden")) {
                e(".alert-tips-wrap").show().find(".alert-tips-inner").html("").html(h);
            } else {
                e(".alert-tips-wrap").find(".alert-tips-inner").html("").html(h);
            }
        } else {
            e("body").append(h);
        }
        c = e(".alert-tips-wrap").length > 0;
        a();
    }
    function a() {
        f = e(".alert-tips-wrap");
...
(function(a) {
    a.fn.qfangPicsPlay = function(b) {
        ...
        return this.each(function() {
            var s = a(this);
            var d = s.find(".js-picsbox");
            var r = d.find("li").length;
            var n = s.find(".js-btnprev");
            var o = s.find(".js-btnnext");
            var e = c.easing;
            var g = c.showSquare;
            var j = 0;
            var i = 0;
            ...
            function m() {
                var z = d.width();
                var A = d.find("li").width();
                var v = new Image();
                v.onload = function() {
                    d.css("height", d.find("li").first().innerHeight(true));
                };
                v.src = d.find("li").first().find("img").attr("src");
                i = Math.floor(z / A);
                f = Math.ceil(r / i);
                q = A * i + (i * parseInt(d.find("li").css("marginLeft"), 10));
                s.find(".js-btnsquare").remove();
                if (f > 1) {
                    var w = '<div class="js-btnsquare btns-square">';
                    for (var x = 0; x < f; x++) {
                        w += "<span></span>";
                    }
                    w += "</div>";
                    ...
                    k = s.find(".js-btnsquare");
                    k.show().find("span").first().addClass("cur");
                    var y = {
                        "marginTop": -(n.height() / 2 + k.outerHeight(true) / 2)
                    };
                    n.css(y);
                    o.css(y);
                    j = 0;
                    p(j);
                    if (c.fixLazyload && a.isFunction(c.fixLazyload)) {
                        c.fixLazyload();
                    }
                }
            }
            ...
            function p(v) {
                k.find("span").eq(v).addClass("cur").siblings().removeClass("cur");
                d.find("ul").stop(true, false).animate({
                    "left": -q * v
                }, {
                    easing: e,
                    duration: 600,
            ...
            s.on("mouseover", ".js-btnsquare > span", function() {
                j = a(this).index();
                p(j);
            ...
            s.hover(function() {
                ...
                if (f > 1) {
                    if (c.rollingAuto) {
                        h = setInterval(l, c.intervalTime);
                    }
                    n.hide();
                    o.hide();
                }
    ...
    a.fn.qfangBanner = function(b) {
        ...
        return this.each(function() {
            ...
            if (s > 1) {
                i();
                q();
                f.find("span").on("mouseover", function() {
                    h = a(this).index();
                    o();
                }).eq(0).trigger("mouseover");
                l.on("click", function() {
            ...
            function i() {
                var w = '<p class="js-dot dot-group">';
                for (var v = 0; v < s; v++) {
                    w += "<span></span>";
                }
                w += '</p><p class="js-btn-prev btns btn-prev"><a href="javascript:;" class="icons"></a></p><p class="js-btn-next btns btn-next"><a href="javascript:;" class="icons"></a></p>';
                t.append(w);
                l = t.find(".js-btn-prev");
                m = t.find(".js-btn-next");
                f = t.find(".js-dot");
            }
            function q() {
                if (!j) {
            ...
            function e() {
                ...
                n.find("li").width(p.width());
            }
            function o() {
                if (s > 1) {
                    f.find("span").eq(h).addClass("cur").siblings().removeClass("cur");
                    var v = -h * p.width();
...
(function(b, c) {
    function a(f, g, d, h) {
        var e = "";
        if (!g.length && d) {
            e += '<p class="title">热门搜索</p>';
        } else {
            if (!g.length && !d) {
                e += '<p class="title">搜索历史</p>';
            }
        }
        e += '<div class="lists"><ul>';
        b.each(f, function(k, j) {
            e += "<li><a " + (h ? 'href="' + j.link + '" target="_blank"' : 'href="javascript:;"') + " " + (j.link && !h ? 'data-src="' + j.link + '"' : "") + '><span class="hs-name fl" ' + (j.id ? 'data-id="' + j.id + '"' : "") + ">" + j.name + "</span>"; !! j.district && (e += '<span class="hs-district fl">' + j.district + "</span>"); !! j.area && (e += '<span class="hs-area fl">' + j.area + "</span>");
            (+j.count > 0) && (e += '<span class="hs-count fr">约' + j.count + "套房源</span>");
            e += "</a></li>";
        });
        e += "</ul></div>";
        if (!g.length && !d) {
            e += '<p class="clear clearfix"><span class="fr">清除历史记录</span><i class="icons fr"></i></p>';
        }
        return e;
    }
    b.fn.qfangAutoCompleter = function(d) {
        var e = {
            data: null,
            cache: true,
            fixed: false,
        ...
        return this.each(function() {
            ...
            if (f.data && f.data.length) {
                if (b("#hybox-" + p).length) {
                    q = a(f.data, b.trim(n.val()), f.cache, f.blank);
                    b("#hybox-" + p).html(q);
                } else {
                    q += '<div class="js-hybox autocompleter-layer js-' + p + '" id="hybox-' + p + '">';
                    q += a(f.data, b.trim(n.val()), f.cache, f.blank);
                    q += "</div>";
                    b("body").append(q);
                }
            ...
            r = b("#hybox-" + p);
            var l = r.find(".clear");
            var h = r.find("li").length;
            f.highlighter && b.isFunction(f.highlighter) && f.highlighter();
            ...
            var j = {
                "position": "absolute",
                "left": n.offset().left,
                "top": n.offset().top + n.outerHeight(true),
                "width": n.outerWidth() - 2
            };
            if (f.fixed) {
                b.extend(j, {
                    "position": "fixed",
                    "top": n.offset().top + n.outerHeight(true) - b(document).scrollTop()
                });
            }
            r.css(j).on("mouseover", "li", function() {
                b(this).addClass("cur").siblings().removeClass("cur");
                g = b(this).index();
            }).on("mouseleave", "li", function() {
                b(this).removeClass("cur");
            }).on("click", "li", function() {
                n.val(b.trim(b(this).find("span").first().text()));
                n.siblings(".placeholder").hide();
                setTimeout(function() {
                    r.remove();
                }, 200);
            });
            l.on("click", function() {
                if (b.isFunction(f.callback)) {
                    f.callback();
                }
                r.remove();
            });
            b(document).on("click.autocompleter", function() {
                r.remove();
            });
            b(window).on("resize.autocompleter", function() {
                if (o) {
                    clearTimeout(o);
                }
                o = setTimeout(function() {
                    if (b(".js-hybox").length) {
                        b(".js-hybox").remove();
                    }
                }, 100);
            });
            n.on("keyup", function(s) {
                if (!r.is(":hidden")) {
            ...
            function m() {
                var s = r.find("li");
                s.eq(g).addClass("cur").siblings().removeClass("cur");
                n.val(s.eq(g).find("span").first().text());
                n.siblings(".placeholder").hide();
            }
        });
    };
...
(function(a) {
    a.fn.qfangHighlighter = function(f, c) {
        var e = {
            divFlag: true,
            divStr: "",
            markClass: "",
        ...
        if (d.markClass) {
            ...
            b = 'style="color:' + d.markColor + ';"';
        }
        a('b[rel="mark"]').each(function() {
            var g = document.createTextNode(a(this).text());
            a(this).replaceWith(a(g));
        });
        a.regTrim = function(i) {
            var h = /[\^\.\\\|\(\)\*\+\-\$\[\]\?]/g;
            var g = {};
            g["^"] = "\\^";
            g["."] = "\\.";
            ...
            a.each(h, function(n, o) {
                if (!/<(?:.|\s)*?>/.test(o)) {
                    a.each(g, function(q, p) {
                        ...
                        var r = new RegExp(a.regTrim(p), "g");
                        if (r.test(o)) {
                            o = o.replace(r, "♂" + p + "♀");
                            m = 1;
                        }
                    });
                    o = o.replace(/♂/g, '<b rel="mark" ' + b + ">").replace(/♀/g, "</b>");
                    h[n] = o;
                }
            });
            var l = h.join("");
...
(function(c) {
    var a = (function a() {
        ...
        return (d.indexOf("msie") != -1) ? parseInt(d.split("msie")[1], 10) : false;
    })();
    var b = new Date().getTime();
    c.fn.refitImage = function(d) {
        function e() {
            var f = c(this);
            var k = this.width || this.naturalWidth || f.width();
            var j = this.height || this.naturalHeight || f.height();
            var l = d.maxWidth;
            var m = d.maxHeight;
            var g = l;
            var n = l * j / k;
        ...
        return this.each(function() {
            ...
            if (a && a < 9) {
                ...
                f.src = this.src + (this.src.indexOf("?") > -1 ? "&" : "?") + b;
            } else {
                if (a) {
                    g.one("load", e);
                    this.src = this.src;
...
(function(a) {
    a.fn.showMore = function(b) {
        ...
        return this.each(function() {
            var g = a(this);
            var e = g.find("." + c.txtCon);
            var f = g.find("." + c.moreBtn);
            if (e.innerHeight() > c.dftH) {
                f.removeClass("dn");
                e.css("height", c.dftH);
            } else {
                e.css("height", "auto");
            ...
            f.on("click", function() {
                if (a(this).hasClass(c.closeFlag)) {
                    a(this).removeClass(c.closeFlag).find("a").html(c.changeHtml);
                    e.css("height", "auto");
                } else {
                    a(this).addClass(c.closeFlag).find("a").html(c.dftHtml);
                    e.css("height", c.dftH);
                }
            });
        });
...
(function(c, d) {
    function a(f, e) {
        ...
        this.showSquare = e.showSquare;
        this.rollingAuto = e.rollingAuto;
        this.intervalTime = e.intervalTime;
        this.fixLazyload = e.fixLazyload;
        this.picsbox = e.picsbox;
        this.container = e.container;
        this.child = e.child;
        this.btnprev = e.btnprev;
        this.btnnext = e.btnnext;
        this.index = e.index;
        this.length = f.find(e.child).length;
        this.speed = 600;
    ...
    a.prototype.init = function() {
        var e = this;
        var f = this.$el;
        var h = this.$el.find(this.btnprev);
        var g = this.$el.find(this.btnnext);
        this.ready();
        this.startAnimate();
        ...
        f.find(".js-btnsquare span").on("mouseover", function() {
            e.index = c(this).index();
            e.playAnimate();
        });
        h.on("click", function() {
            e.prev();
    ...
    a.prototype.ready = function() {
        var f = this.$el;
        var i = this.$el.find(this.picsbox);
        var h = this.$el.find(this.btnprev);
        var g = this.$el.find(this.btnnext);
        var e = new Image();
        e.onload = function() {
            i.css({
                "height": i.find("li:first").innerHeight(true)
            });
        };
        e.src = i.find("li:first img").attr("src");
        h.css({
            "marginTop": -(h.height() / 2 + f.find(".js-btnsquare").outerHeight(true) / 2)
        });
        g.css({
            "marginTop": -(h.height() / 2 + f.find(".js-btnsquare").outerHeight(true) / 2)
        });
        ...
        this.$el.find(this.child + ":eq(" + this.index + ")").addClass("current").siblings(".current").removeClass("current");
        this.$el.find(this.container).css({
            "left": -this.index * i.width()
        });
        this.showSquare && this.initSquares();
        this.fixLazyload && c.isFunction(this.fixLazyload) && this.fixLazyload();
    };
    a.prototype.initSquares = function() {
        var e = '<div class="btns-square js-btnsquare">';
        for (var f = 0; f < this.length; f++) {
            e += "<span" + (f === this.index ? ' class="cur"' : "") + "></span>";
        }
        e += "</div>";
        if (this.$el.find(".js-btnsquare").length) {
            this.$el.find(".js-btnsquare").remove();
        }
        this.$el.append(e);
        this.$el.find(".js-btnsquare").show();
    };
    a.prototype.setSquares = function() {
        this.$el.find(".js-btnsquare span:eq(" + this.index + ")").addClass("cur").siblings("span").removeClass("cur");
    };
    a.prototype.playAnimate = function() {
        ...
        this.$el.find(this.container).stop(true, false).animate({
            "left": -this.index * this.$el.find(this.picsbox).width()
        }, {
            easing: this.easing,
            speed: this.speed,
    ...
    a.prototype.startAnimate = function() {
        var e = this;
        if (this.rollingAuto) {
    ...
    a.prototype.stopAnimate = function() {
        if (this.rollingAuto) {
    ...
    a.prototype.reset = function(e, f) {
        this.index = e;
        this.length = f;
        this.ready();
    };
    ...
    c.fn.qfangFocusedDataPlay = b;
}(jQuery));
$(function() {
    var c = $("#curCity");
    var h = $("#cityLayer");
    var e = h.find(".cities-layer-close");
    c.on("click", function(j) {
        j.stopPropagation();
        var k = ($(this).attr("data-type") === "navmid-city") ? true : false;
        var i = {
            "top": 42,
            "opacity": 1
        };
    ...
    $("body,input").on("click", function(i) {
        g();
        if ($(i.target).attr("id") != "cityLayer") {
            g();
        }
    });
    ...
    $("#topNavMenu, #topNavMenuRight").find("li").hover(function() {
        var j = $(".qfang-navmain").hasClass("qfang-navmain-small") ? true : false;
        var i = {
            "top": 42,
            "opacity": 1
        };
        ...
        $(this).find(".navmenu-linksub").show().stop().animate(i);
    }, function() {
        var j = $(".qfang-navmain").hasClass("qfang-navmain-small") ? true : false;
        var i = {
            "top": 62,
        ...
        $(this).find(".navmenu-linksub").hide().stop().animate(i);
    });
    $("#linksFriendly").qfangSetTab({
        tabLink: "linksfriendlyTabs li",
        tabFrame: "links-friendly-item",
        triggerEvent: "mouseover"
    });
    var f = $("#citySelected");
    var a = $("#citySelectedLayer");
    var d = a.find(".cities-layer-close");
    ...
    $("body,input").on("click", function(i) {
        b();
        if ($(i.target).attr("id") != "citySelectedLayer") {
            b();
        }
    });
    ...
    $("#navigationMenu, #navigationLogin").find("li").hover(function() {
        $(this).find(".nav-linksub").show().stop().animate({
            "top": 44,
            "opacity": 1
        });
    }, function() {
        $(this).find(".nav-linksub").hide().stop().animate({
            "top": 60,
            "opacity": 0
        });
    });
    $("#navigationMiniMenu, #navigationMiniLogin").find("li").hover(function() {
        $(this).find(".nav-linksub").show().stop().animate({
            "top": 26,
            "opacity": 1
        });
    ...
    (function(i) {
        i.qfangAdChange = function(j) {
            ...
            k.each(function(r, m) {
                ...
                function s(u) {
                    t.find("li").eq(u).addClass("cur").fadeIn(p).siblings().fadeOut(p).removeClass("cur");
                }
            });
        };
    })(jQuery);
